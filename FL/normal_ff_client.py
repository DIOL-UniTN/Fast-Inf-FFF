...
def load_data(client_id):
    ...
    trainset = MNIST("../data", train=True, download=False, transform=transform)
...
class Net(nn.Module):
    def __init__(self, input_width, hidden_width, output_width) -> None:
...
def main(client_id: int, serv_addr="0.0.0.0:8080"):
    l = 16
    d = 3
    net = Net(input_width=784, hidden_width=l * (2**d), output_width=10).to(DEVICE)
